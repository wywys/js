var rule = {
   ...
   二级:{
        ...
        lists:'.module-blocklist:eq(#id) a'//集数，播放地址
    //tab_text:'body&&Text',list_text:'body&&Text',list_url:'a&&href'
    }, 
    
    // 搜索可以是*,集成一级，或者跟一级一样的写法 列表;标题;图片;描述;链接;详情
    搜索:'.module-list&&.module-items&&.module-search-item;.video-cover&&img&&alt;.video-cover&&.module-item-pic&&img&&src;.video-info&&.video-serial&&Text;.video-cover&&a&&href',
