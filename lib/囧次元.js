var rule = {
   ...
   一级:`js:
    ...
    let list=pdfa(html,".module-list&&.module-item");
    list.forEach((it)=>{d.push({title:pdfh(it,".module-item-style&&a&&title"),desc:pdfh(it,".module-item-text&&Text"),pic_url:pd(it,".module-item-pic&&img&&data-src"),url:pd(it,"a&&href"),})});
    setResult(d);
    `,
   二级:{
        title:'',//片名;类型
