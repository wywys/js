var rule = {
   ...
   搜索:'js:var d=[];pdfh=jsp.pdfh;pdfa=jsp.pdfa;pd=jsp.pd;var html=request(input);let list=pdfa(html,".module&&.module-items&&.module-search-item");list.forEach(function(it){d.push({title:pdfh(it,".video-cover&&img&&alt"),desc:pdfh(it,".video-info&&.video-serial&&Text"),pic_url:pd(it,".video-cover&&img&&src"),url:pd(it,".video-cover&&a&&href"),})});setResult(d);',
